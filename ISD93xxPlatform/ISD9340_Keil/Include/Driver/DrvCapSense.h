...
/*---------------------------------------------------------------------------------------------------------*/
#define DRVCAPSENSE_MAJOR_NUM	1
#define DRVCAPSENSE_MINOR_NUM	00
#define DRVCAPSENSE_BUILD_NUM	1
/*---------------------------------------------------------------------------------------------------------*/
/*  Version define with SysInfra				                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define DRVCAPSENSE_VERSION_NUM     _SYSINFRA_VERSION(DRVCAPSENSE_MAJOR_NUM, DRVCAPSENSE_MINOR_NUM, DRVCAPSENSE_BUILD_NUM)
