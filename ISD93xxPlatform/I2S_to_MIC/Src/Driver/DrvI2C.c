...
/* Parameters:                                                                                             */
/*               port 		   - [in]		I2C_PORT0 				       		                           */
/*               u32clock_Hz 	   - [in]		I2C clock source frequency (Hz)       		               */
...
/* Parameters:                                                                                             */
/*               port 		   - [in]		I2C_PORT0                      	                               */
/*               u32clock_kHz 	  - [in]	I2C clock source frequency (KHz)       		                   */
...
/* Parameters:                                                                                             */
/*               port 		   - [in]		I2C_PORT0 				       		                           */
/*               clock_kHz 	   - [in]		I2C clock source frequency (KHz)       		                   */
/* Returns:                                                                                                */
/*               I2C bit rate 											                    		       */
/*               							                                                               */
/* Description:                                                                                            */
...
uint32_t DrvI2C_GetClock(E_I2C_PORT port, uint32_t u32clock)
{
	...
	return ( (u32clock<<2) / (((u32divider+1)<<4)-8) );
}
