...
void i32BiqSetting(uint8_t u8Path);
void u32BiqSetting(uint8_t u8Path);

/*---------------------------------------------------------------------------------------------------------*/
/* Define global variables                                                                                 */
/*---------------------------------------------------------------------------------------------------------*/
#define MIC_BUFFERSIZE 0x100 * 2	
...
#define I2S_BUFFERSIZE 0x80				//half of MIC_BUFFERSIZE
__align(4) int16_t I2sBuffer[2][I2S_BUFFERSIZE];
...
void InitialADC(void)
{
	...
	/* Open Analog block */
	//DrvADC_AnaOpen();	  					//Will reset whole analog IP
	...
	//DrvADC_SetPGAGaindB(2000);		//-200: -2dB, 2000: 20dB  
	DrvADC_SetPGAGaindB(0);
	...
	sParam.u8SDAdcDivisor = 8;	//OSR128 :48 for 8K, 24 for 16K, 8 for 48K
	//sParam.u8SDAdcDivisor = 8;		//OSR192 :32 for 8K, 16 for 16K, 8 for 32K
